...
import { OccupationFilterCard, DegreeFilter,AlumniComponent } from '@/components'
...
<button type='button' onClick={clearAllFilter} className='w-fit flex gap-1 align-middle justify-center py-2 px-4 hover:py-1.5 rounded-lg bg-red-950  hover:border-2 hover:border-red-700'>
