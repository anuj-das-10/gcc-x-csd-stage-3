...
const AddAdminForm = () => {
    ...
    const handleNewAdminSubmit = async (e) => {
        ...
        console.log(form_values.create_password);
        console.log(form_values.confirm_password);

        // Input Password Check before submission
        if(form_values.create_password == form_values.confirm_password) {
            try {                          
...
return (
    ...
    <div className="w-full rounded-xl shadow border bg-gray-900 border-gray-700">
        <div className="p-6  md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleNewAdminSubmit}  action='/api/admin/addNewAdmin' method='POST'>
                <div>
